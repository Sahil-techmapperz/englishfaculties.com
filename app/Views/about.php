...
<head>
    ...
    <title>English Faculties - Online Courses & Education HTML Template - About Us</title>
    <meta name="robots" content="INDEX,FOLLOW">
    <!-- Mobile Specific Metas -->
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicons - Place favicon.ico in the root directory -->
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?= base_url('public/assets/img/favicons/ms-icon-144x144.png')?> ">
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="<?= base_url('public/assets/img/bg/breadcumb-bg.jpg') ?> " data-overlay="title" data-opacity="8">
        <div class="breadcumb-shape" data-bg-src="<?= base_url('public/assets/img/bg/breadcumb_shape_1_1.png') ?> ">
        </div>
        <div class="shape-mockup breadcumb-shape2 jump d-lg-block d-none" data-right="30px" data-bottom="30px">
            <img src="<?= base_url('public/assets/img/bg/breadcumb_shape_1_2.png') ?> " alt="shape">
        </div>
        <div class="shape-mockup breadcumb-shape3 jump-reverse d-lg-block d-none" data-left="50px" data-bottom="80px">
            <img src="<?= base_url('public/assets/img/bg/breadcumb_shape_1_3.png') ?> " alt="shape">
        </div>
        <div class="container">
...
==============================-->
            ...
            <div class="row gy-4 justify-content-center">
                    ...
                    <div class="service-card style3">
                        <div class="service-card-content">
                            <div class="service-card-icon">
                                <img src="<?= base_url('public/assets/img/icon/service-icon-3-1.svg') ?> " alt="Icon">
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card style3">
                        <div class="service-card-content">
                            <div class="service-card-icon">
                                <img src="<?= base_url('public/assets/img/icon/service-icon-3-2.svg') ?> " alt="Icon">
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card style3">
                        <div class="service-card-content">
                            <div class="service-card-icon">
                                <img src="<?= base_url('public/assets/img/icon/service-icon-3-3.svg') ?> " alt="Icon">
                            </div>
    ...
    <!--============================== About Area  ==============================-->
    <div class="overflow-hidden bg-smoke space" id="about-sec" data-bg-src="<?= base_url('public/assets/img/bg/about-5-bg.png') ?> ">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 mb-50 mb-xl-0">
                    <div class="img-box4">
                        <div class="img1">
                            <img class="tilt-active" src="<?= base_url('public/assets/img/normal/about_5_1.png') ?> " alt="About">
                        </div>
                        ...
                        <div class="img2">
                            <img class="tilt-active" src="<?= base_url('public/assets/img/normal/about_5_2.png') ?> " alt="About">
                        </div>
                        <div class="shape1 shape-mockup jump" data-bottom="0" data-left="-46px">
                            <img src="<?= base_url('public/assets/img/normal/about_5_1shape.png') ?> " alt="About">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    ...
                    <div class="row mb-35 gy-4">
                        <div class="col-lg-6">
                            <div class="about-grid3">
                                <div class="about-grid-icon"><img src="<?= base_url('public/assets/img/icon/about-grid-icon2-1.svg') ?> " alt="icon"></div>
                                <div class="details">
                        ...
                        <div class="col-lg-6">
                            <div class="about-grid3">
                                <div class="icon"><img src="<?= base_url('public/assets/img/icon/about-grid-icon2-2.svg') ?> " alt="icon"></div>
                                <div class="details">
...
Counter Area  
==============================-->
    <div class="counter-area-2" data-bg-src="<?= base_url('public/assets/img/bg/counter-bg_1.png') ?> ">
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="team-card style2">
                        <div class="team-img-wrap">
                            ...
                            <div class="team-img">
                                <img src="<?= base_url('public/assets/img/team/team_2_1.jpg') ?> " alt="Team">
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="team-card style2">
                        <div class="team-img-wrap">
                            ...
                            <div class="team-img">
                                <img src="<?= base_url('public/assets/img/team/team_2_2.jpg') ?> " alt="Team">
                            </div>
                            <div class="team-social">
                                <a href="#" class="icon-btn">
                                    <i class="far fa-plus"></i>
                ...
                <div class="col-lg-6">
                    <div class="team-card style2">
                        <div class="team-img-wrap">
                            ...
                            <div class="team-img">
                                <img src="<?= base_url('public/assets/img/team/team_2_4.jpg') ?> " alt="Team">
                            </div>
                            <div class="team-social">
                                <a href="#" class="icon-btn">
                                    <i class="far fa-plus"></i>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-30 mb-lg-0">
                    <div class="cta-card" data-bg-src="<?= base_url('public/assets/img/bg/cta-bg_3_1.png') ?> ">
                ...
                <div class="col-lg-6">
                    <div class="cta-card" data-bg-src="<?= base_url('public/assets/img/bg/cta-bg_3_2.png') ?> ">
                        <div class="title-area mb-40">
                            <span class="sub-title text-white"><i class="fal fa-book me-2"></i>Popular Courses</span>
            ...
            <div class="row slider-shadow th-carousel blog-slider-1" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2" data-sm-slide-show="1" data-arrows="true">
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="<?= base_url('assets/img/blog/blog-1-1.jpg') ?>" alt="Blog Image"></a>
                        </div>
...
Cta Area  
==============================-->
    <div class="cta-area-1" data-bg-src="<?= base_url('public/assets/img/bg/cta-bg1.png') ?> ">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-8">
